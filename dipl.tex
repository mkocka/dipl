...
\fancyhead[R]{\footnotesize PAGE \thepage\ of 60 }
...
\begin{enumerate}
 \item \verb rbnrmf  was used for creating a rebinning response matrix for 10 spectral bins in 20--100 keV
 \item \verb og_create  was used to create observation groups
 \item \verb ibis_science_analysis  package was used for the image reconstruction and creating mosaics
...
In the next step of the analysis thread it was checked which of the 25 IPs observed by XMM have also been 
observed by INTEGRAL and have enough exposures for necessary spectral extraction. The seven sources 
have been selected for a spectral extraction.   

The spectra from all suitable MOS observations were taken by standard SAS data product extraction. The 
...
\begin{enumerate}
 ...
 \item \verb arfgen  was used to genarate an ancillary file.
 \item \verb specgroup  was used for rebining  the spectrum and linking the associated files.
\end{enumerate}
