...
but they are too faint, too far in the universe. You are looking for “laboratory” which similar
 ...
 several types of such binaries disused, but closer look is taken to intermediate polars. 
...
\begin{itemize}
 \item \textbf{Relativistic jet phenomena}: like it is proposed \citet{mirabel:1} that universal 
mechanism should be at work in all the relativistic jet sources in the universe. Better understanding 
of sources as: microblazars, AGNs and gamma-ray burst will help to gain more comprehensive 
understanding of this phenomena. Microblazars are playing role of very close “space laboratories”.       
 \item \textbf{White dwarfs masses in IP}:
 \item \textbf{GXRE}:
\end{itemize}
