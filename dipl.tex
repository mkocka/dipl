...
The non-magnetic CV could looks like fig.\ref{cv1} The secondary is a small main sequence star with mass about 
...
\end{itemize}
The conventional idea about where the gap comes from is 

\begin{figure}[hbt!]
\centering
\includegraphics[totalheight=9cm]{plot/cv_orbper.png}
